    ...
    public function boot()
    {
        ...
        if (! class_exists('CreateActivityLogTable')) {
            ...
            $this->publishes([
                ...
                __DIR__.'/../migrations/create_activity_log_ip_table.php.stub' => database_path("/migrations/{$timestamp}_create_activity_log_ip_table.php"),
                __DIR__.'/../migrations/create_activity_log_request_table.php.stub' => database_path("/migrations/{$timestamp}_create_activity_log_request_table.php"),
            ], 'migrations');
        }
    }
